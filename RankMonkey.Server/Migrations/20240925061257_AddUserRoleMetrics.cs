...
{
    /// <inheritdoc />
    public partial class AddUserRoleMetrics : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_AuthType", "auth_type IN ('Google')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    income = table.Column<long>(type: "INTEGER", nullable: false, defaultValue: 0L),
                    net_worth = table.Column<long>(type: "INTEGER", nullable: false, defaultValue: 0L),
                    currency = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    timestamp = table.Column<long>(type: "INTEGER", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_metrics", x => x.user_id);
                    table.ForeignKey(
                        name: "FK_metrics_user_user_id",
                        column: x => x.user_id,
                        principalTable: "user",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_metrics_income",
                table: "metrics",
                column: "income");

            migrationBuilder.CreateIndex(
                name: "IX_metrics_net_worth",
                table: "metrics",
                column: "net_worth");
